...
interface MenuProps {
    addMaterialToFilterList: void
    updateMaterialFilterList: void
...
export default function Menu(props: MenuProps) {
    const { addMaterialToFilterList, updateMaterialFilterList, filterPresets, toggleFilter } = props
    ...
    return (
        <div className="hidden h-96 justify-between sticky top-4 lg:flex flex-col gap-y-4 justify-items-start w-full max-w-xs 2xl:max-w-lg my-4">
            {/* <MenuAutoComplete addMaterialToList={addMaterialToFilterList} /> */}
            <Combobox value={selectedMaterials} onChange={setSelectedMaterials} nullable multiple>
                {/* <Combobox.Input as={Fragment} onChange={(event) => {}} /> */}
                <Combobox.Options></Combobox.Options>
            </Combobox>
            <div className="rounded-xl bg-brown">{selectedMaterials}</div>

    ...
    render() {
        return (
            <div className="-mt-32 lg:mt-0 w-full lg:w-3/5 relative">
                ...
                <p className={"w-2/5 lg:w-56 ml-8 rounded-full capitalize p-4 text-xl lg:text-3xl text-white text-center transform -rotate-3 " + this.props.color}>{this.props.speaker}</p>

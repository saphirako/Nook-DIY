...
export default class ItemFocusScreen extends Component {
    ...
    render() {
        return this.state ? (<div className="h-3/4 py-12 bg-brown-200 flex flex-row justify-between text-brown-600 overflow-hidden">
            ...
            <div className="w-1/4 xl:w-1/5 flex flex-col -mr-2 xl:-mr-8 gap-10 rounded-2xl p-4 pr-0 bg-brown-100 self-center justify-center items-start h-auto">
                {Object.keys(this.state.materials).map(ingredient => <RecipeIngredient name={ingredient} quantity={this.state.materials[ingredient]} />)}
            </div>
        </div>)
            :

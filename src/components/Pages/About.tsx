        ...
        >
            <div className="flex flex-col items-end lg:items-center justify-center h-full lg:h-auto">
                ...
                <SpeechBubble speaker="Saphirako" color="bg-blue-500">
                    <p>
                        NookDIY is a side project powered by React, Netlify, and
                        a little bit of Python. If you notice a bug, would like
                        to contribute to the project, or have questions, please
